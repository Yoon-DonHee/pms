...
public class QBoard extends EntityPathBase<Board> {
    ...
    private static final long serialVersionUID = 1580065587L;

    public static final QBoard board = new QBoard("board");

    public final reservation.pms.domain.QBaseEntity _super = new reservation.pms.domain.QBaseEntity(this);
